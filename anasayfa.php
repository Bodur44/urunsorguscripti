...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Bodur Medya">
...
if (isset($_POST["buton"])) {
  ...
  $lisanslar = $sorgu->fetchAll(PDO::FETCH_ASSOC);

  $dogrulandi = false;
  foreach ($lisanslar as $lisanscek) {
      $lisanskod = $lisanscek["lisanslar_kod"];
      $lisansad = $lisanscek["lisanslar_ad"];

      if ($lisans == $lisanskod) {
          echo '<script>Swal.fire("", "Ürün Adı: ' . $lisanskod . '</br> Ürün Fiyatı: ' . $lisansad . '", "success"); </script>';
          $dogrulandi = true;
          break;
      }
  }
