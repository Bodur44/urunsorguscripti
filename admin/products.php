    ...
    $(document).ready(function() {
      $('#arama').on('input', function() {
        ...
        $('#mytable tr').filter(function() {
          $(this).toggle($(this).text().toLowerCase().indexOf(aramaMetni) > -1);
        });
      });
    });
  </script>
               ...
               ?>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="card-header py-3">  <div class="col-md-6 mx-auto width: 200px;">

                   
Ürün Eklemek İçin Tıkla: <a href="product-ekle"><button class="btn btn-primary">EKLE</button></a>
</div></br><form action="">
        <input type="text" class="form-control w-100 " id="arama" placeholder="Tabloda Ara..">
      </form>
